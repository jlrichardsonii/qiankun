 ...
 * @since 2020-04-13
 */
import { isBoundedFunction, isCallable, isConstructable } from '../utils'; // Get native global window with a sandbox disgusted way, thus we could share it between qiankun instances🤪
// eslint-disable-next-line no-new-func

var nativeGlobal = new Function('return this')();
Object.defineProperty(nativeGlobal, '__currentRunningSandboxProxy__', {
  enumerable: false,
  writable: true
});
